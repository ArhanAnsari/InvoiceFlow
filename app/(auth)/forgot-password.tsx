        ...
        <GlassCard dark={isDark} style={styles.card}>
          {!sent ? (
            ...
            <View style={styles.successBox}>
              <Ionicons name="checkmark-circle-outline" size={48} color={T.success} />
              <Text style={styles.successText}>Check your email inbox for the recovery link.</Text>
            </View>
          )}
        </GlassCard>
...
function createStyles(T: typeof Colors.dark) { return StyleSheet.create({
  ...
  h1: { ...Typography.h2, color: T.text, marginBottom: 8, textAlign: "center" },
  subtitle: { ...Typography.body, color: T.textMuted, textAlign: "center", lineHeight: 22 },
  card: { marginBottom: Spacing.xl },
  successBox: { alignItems: "center", gap: 12, paddingVertical: 8 },
  successText: { ...Typography.body, color: T.textSecondary, textAlign: "center" },
